...
let filter_URL = {
    0 : `${API_TMDb_DISCOVER_URL}&primary_release_date.lte=${date.getFullYear()}-${date.getMonth()+1}-${date.getDate()}&sort_by=release_date.desc&region=fr`,
    1: `${API_TMDb_DISCOVER_URL}&sort_by=popularity.desc&region=fr`,
    2: `${API_TMDb_DISCOVER_URL}&primary_release_date.gte=${date.getFullYear()}-${date.getMonth()+1}-${date.getDate()}&sort_by=release_date.asc&region=fr`,
